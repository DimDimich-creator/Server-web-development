...
Для просмотра выполненной работы можно перейти по ссылке:
  - [Форма](http://dimdimich.ru:30002/lab2.php)

  - [Получение заголовка](http://dimdimich.ru:30002/lab2_2.php)
...
### Инструкции
Для просмотра выполненной работы можно перейти по ссылке 
(для корректной работы рекомендуется вводит уравнение строго в формате неизвестная оператор переменная = переменная): [Решение уравнений](http://dimdimich.ru:30002/lab4.php)
...
### Инструкции
Для просмотра выполненной работы можно перейти по ссылке: [Калькулятор](http://dimdimich.ru:30002/lab5.html).
